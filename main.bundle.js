...
module.exports = "<div>\n  <p>\n    Item Count : ({{itemCount}})\n  </p>\n  <form>\n    <table>\n      <tr>\n        <td>\n          Enter Item\n        </td>\n        <td>\n          <input type=\"text\" name=\"txtitem\" placeholder=\"Enter Item\" [(ngModel)]=\"goalText\">\n\n        </td>\n      </tr>\n      <tr>\n        <td>\n          <input type=\"submit\" [value]=\"btnSubmit\" (click)=\"addItem()\">\n        </td>\n        <td></td>\n      </tr>\n    </table>\n    <div [@goalCnt]='goalCnt.length'>\n      <p *ngFor=\"let goal of goalCnt\" (click)=\"removeItem()\">\n        My Goals are : {{ goal }}\n      </p>\n    </div>\n  </form>\n</div>"
...
var HomeComponent = (function () {
    function HomeComponent() {
        this.itemCount = 0;
        this.btnSubmit = 'Add Item';
        this.goalText = 'Learn Anguler 5';
        this.goalCnt = [];
    }
    HomeComponent.prototype.ngOnInit = function () {
        this.itemCount = this.goalCnt.length;
    };
    HomeComponent.prototype.addItem = function () {
        this.goalCnt.push(this.goalText);
        this.goalText = "";
        this.itemCount = this.goalCnt.length;
    };
    HomeComponent.prototype.removeItem = function () {
        this.goalCnt.pop();
        this.itemCount = this.goalCnt.length;
    };
    HomeComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            animations: [
                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["l" /* trigger */])('goalCnt', [
                    Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["k" /* transition */])('* =>*', [
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["g" /* query */])(':enter', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["i" /* stagger */])('300ms', [
                            Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["e" /* animate */])('.6s ease-in', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["f" /* keyframes */])([
                                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["j" /* style */])({ opacity: 0, transform: 'translateY(-100%)', offset: 0 }),
                                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["j" /* style */])({ opacity: .5, transform: 'translateY(-20%)', offset: .3 }),
                                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["j" /* style */])({ opacity: 1, transform: 'translateY(-75%)', offset: 1 })
                            ]))
                        ]), { optional: true }),
                        Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["g" /* query */])(':leave', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["i" /* stagger */])('300ms', [
                            Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["e" /* animate */])('.6s ease-in', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["f" /* keyframes */])([
                                ...
                                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["j" /* style */])({ opacity: .5, transform: 'translateY(35%)', offset: .3 }),
